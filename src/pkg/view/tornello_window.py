...
class TurnstileView(ctk.CTkFrame):
    def __init__(self, parent, access_manager, access_history, app=None, **kwargs):
        ...
        ctk.CTkLabel(manual_frame, text="Simula Lettura Tessera:", font=ctk.CTkFont(family="Montserrat", size=13, weight="bold"), text_color=("#86868B", "#98989D")).pack(anchor="w", pady=(0, 5))
    ...
    def simulate_badge(self, event=None):
        ...
        if badge_str:
            ...
            self.access_manager.process_badge(full_badge, settings, gym_prefix)
